    ...
    <div class="hk-pg-wrapper">
        ...
        <div class="container mt-xl-50 mt-sm-30 mt-15">
            ...
            <div class="hk-pg-header align-items-top">
                <div>
                    <h2 class="hk-pg-title font-weight-600 mb-10">@yield('title', 'User !')</h2>
                    ...
                    <div class="hk-row">
                        ...
                        <div class="col-xl-12" data-select2-id="12">
                            <section class="hk-sec-wrapper" data-select2-id="11">
                                ...
                                <div class="row">
                                    <div class="col-sm">
                                        <form action="{{ route('dash.setting.update', $setting->id) }}" method="post"
                                            enctype="multipart/form-data">
                                            @csrf
                                            @method('PUT')
                                            <div class="form-group mb-2">
                                                <img src="{{ $setting->favicon }}" width="75px" height="75px"
                                                    alt="">
                                            ...
                                            <div class="form-group mb-2">
                                                <img src="{{ $setting->logo }}" width="75px" height="75px" alt="">
                                                <div class="fileinput fileinput-new input-group" data-provides="fileinput">
                                                    <div class="input-group-prepend">
