    ...
    <div class="hk-pg-wrapper">
        ...
        <div class="container mt-xl-50 mt-sm-30 mt-15">
            ...
            <div class="hk-pg-header align-items-top">
                <div>
                    <h2 class="hk-pg-title font-weight-600 mb-10">@yield('Title', 'Edit Skills !')</h2>
                    ...
                    <div class="hk-row">
                        ...
                        <div class="col-xl-12" data-select2-id="12">
                            <section class="hk-sec-wrapper" data-select2-id="11">
                                ...
                                <div class="row">
                                    <div class="col-sm">
                                        <form action="{{ route('dash.skill.update', $skill->id) }}" method="post"
                                            ...
                                            <div class="form-group mb-3">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" value="{{ $skill->description }}" name="description" class="form-control"
                                                        aria-label="Default" aria-describedby="inputGroup-sizing-default">
                                                </div>
                                                @error('description')
                                                    <span class="text-danger">{{ $message }}</span>
                                            ...
                                            <div class="form-group mb-2">
                                                <img src="{{ $skill->image }}" width="75px" height="75px" alt="">
