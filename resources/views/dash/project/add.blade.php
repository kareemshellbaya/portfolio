    ...
    <div class="hk-pg-wrapper">
        ...
        <div class="container mt-xl-50 mt-sm-30 mt-15">
            ...
            <div class="hk-pg-header align-items-top">
                <div>
                    <h2 class="hk-pg-title font-weight-600 mb-10">@yield('Title', 'Project !')</h2>
                    ...
                    <div class="hk-row">
                        ...
                        <div class="col-xl-12" data-select2-id="12">
                            <section class="hk-sec-wrapper" data-select2-id="11">
                                ...
                                <div class="row">
                                    <div class="col-sm">
                                        <form action="{{ route('dash.project.store') }}" method="post"
                                            ...
                                            <div class="form-group mb-3">
                                                <div class="input-group">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text"
                                                            id="inputGroup-sizing-default">Github_Link</span>
                                                    </div>
