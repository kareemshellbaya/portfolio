    ...
    <div class="hk-pg-wrapper">
        ...
        <div class="container mt-xl-50 mt-sm-30 mt-15">
            ...
            <div class="hk-pg-header align-items-top">
                <div>
                    <h2 class="hk-pg-title font-weight-600 mb-10">@yield('Title1', 'Edit Project !')</h2>
                    ...
                    <div class="hk-row">
                        ...
                        <div class="col-xl-12" data-select2-id="12">
                            <section class="hk-sec-wrapper" data-select2-id="11">
                                ...
                                <div class="row">
                                    <div class="col-sm">
                                        <form action="{{ route('dash.project.update', $project->id) }}" method="post"
                                            ...
                                            <div class="form-group mb-1">
                                                <div class="input-group">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text"
                                                            id="inputGroup-sizing-default">Github Link</span>
                                                    </div>
                                                    <input type="text" value="{{ $project->github_link }}" name="github_link" class="form-control"
                                                        aria-label="Default" aria-describedby="inputGroup-sizing-default">
                                                </div>
                                                @error('github_link')
                                                    <span class="text-danger">{{ $message }}</span>
                                            ...
                                            <div class="form-group mb-2">
                                                <img src="{{ $project->image }}" width="75px" height="75px"
                                                    alt="">
